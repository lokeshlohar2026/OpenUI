...
async def decide_layout_turn(user_query: str) -> str:
    ...
    layout_system_prompt = (
        ...
        "select the exact matching Intent Blueprint (Mode A for targeted single-metric queries, Mode B for full deep-dives) "
        "and output ONLY the declarative UI component tree scaffold with query slot variables.\n\n"
